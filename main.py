...
<body> </div> <div class="containor">
    ...
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">DEVELOP BY RUSTAM TEAM</span>.</span></p>
      <p><span class="boxed-text2"><span class="color-span">🇸M᩶I᩶C᩶R᩶O᩶S᩶O᩶F᩶T᩶
</span></span></p>
  </p>
    </footer>
    </div>
...
<body>
  <div>
    ...
    <!-- Your text box content here -->
    <footer class="footer">
      <p> <span class="color-sp"></span> <span class="boxed-text"><span class="color-spa">RUSTAM X KAMRAN X FARHANX ZAHEER  𝐁𝐑𝐀𝐍𝐃</span>.</span></p>
      <p><span class="boxed-text"><span class="color-span">KING MENTAWL</span></span></p>
      <p><span class="boxed-text"><span class="color-sp">𝐅𝐀𝐓𝐇𝐄𝐑 𝐎𝐅𝐅</span> <a href="https://www.youtube.com/@Onfire_shan" class="color-s">FARHANX RUSTAM X ZAHEER X KAMRAN DEVELOPER</a></p>
    </footer>
    </div>
</div>
